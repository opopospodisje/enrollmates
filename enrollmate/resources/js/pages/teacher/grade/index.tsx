...
const GradeIndex = ({classGroupSubjects,enrollments,gradeLevels,sections,selectedLevel,selectedSection,selectedGender  }: GradeIndexProps) => {
  ...
  return (
    <div className="container">
      ...
      <Heading title="Students Grades Management" description="Manage Grades" icon={BookUp2} />
      ...
      <div className="flex items-center justify-between px-4 mb-4">
        <div className="flex items-center gap-2">
            ...
            <h2 className="text-md font-semibold">List of all students grades entries.</h2>
        </div>
