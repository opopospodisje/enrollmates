...
import { BookUp2, ChevronLeft, List } from 'lucide-react';
...
import { getColumns } from './Components/studentBySubjectColumns';
...
const SubjectShow = ({students, subject,selectedLevel,selectedSection,selectedGender,gradeLevels,sections }: ClassGroupIndexProps) => {
  ...
  const table = useReactTable({
    ...
    const handleLevelFilterChange = (level: string) => {
      router.get(route('teacher.subjects.show', subject.id), { 
        level,
  ...
  return (
    <>    
      ...
      <div>
        <Link href={route('teacher.subjects.index')}><Button variant={'default'}> <ChevronLeft /> Back</Button></Link>  
      </div>
      ...
      <div className="flex items-center justify-between px-4 my-4">
          <div className="flex items-center gap-2">
              ...
              <h2 className="text-md font-semibold">List of all students in this subject.</h2>
          </div>
...
SubjectShow.layout = (page: React.ReactNode) => (
