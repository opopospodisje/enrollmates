...
type StudentIndexProps = {
  ...
  nonGraduatedStudents:Student[];
};

const StudentIndex = ({ graduatedStudents,nonGraduatedStudents}: StudentIndexProps) => {
  ...
  return (
    <div className="container">
      ...
      <Heading title="Graduates Management" description="Apply Students for Graduation" icon={BookUp2} />
      ...
      <div className="flex items-center justify-between my-4">
        <div className="flex items-center gap-2">
            ...
            <h2 className="text-md font-semibold">List of all students graduated.</h2>
        </div>
        <CreateStudentDialog students={nonGraduatedStudents} />
      </div>
