...
import { BookUp2, CalendarClock, CalendarDays, ChartBar, List, PencilLine, SquarePen, Tally5, VenusAndMars } from 'lucide-react';
...
const EditApplicantDialog = ({ applicant ,gradeLevels,schoolYears,currentSchoolYear, buttonStyle}: Props) => {
  ...
  const getDefaultApplicantFormData = (): Applicant => ({
    ...
    school_year_id: (applicant.school_year_id ?? currentSchoolYear?.id) || 0,

    entrance_exam_score: applicant.entrance_exam_score || null,
    exam_taken_at: applicant.exam_taken_at || '',
  });
