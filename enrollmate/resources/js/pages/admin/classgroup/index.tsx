...
import { getColumns } from './Components/classGroupColumns';
...
const ClassGroupIndex = ({classGroups, sections, schoolYear,schoolYears }: ClassGroupIndexProps) => {
  ...
  return (
    <div className="container">
      ...
      <Heading title="Class Group Management" description="Manage Class Groups" icon={BookUp2} />
      ...
      <div className="flex items-center justify-between px-4 mb-4">
          ...
          <CreateClassGroupDialog sections={sections} schoolYear={schoolYear} schoolYears={schoolYears}/>
      </div>
