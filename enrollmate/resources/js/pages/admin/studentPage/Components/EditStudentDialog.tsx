...
import { CalendarCheck, CalendarDays, FileDigit, FilePlus, List, Mail, MapPin, Pencil, PencilLine, SquarePen, VenusAndMars } from 'lucide-react';
...
const EditStudentDialog = ({ student,applicants , buttonStyle}: Props) => {
  ...
  const getDefaultStudentFormData = (): Student => ({
    id: student.id,
    applicant_id: student.applicant_id || 0,
    lrn: student.lrn || '',
  ...
  console.log('Current applicant_id:', student.applicant_id);
  console.log('Select value:', student.applicant_id ? student.applicant_id.toString() : '');
  console.log('Applicants IDs:', applicants.map(a => a.id));
            ...
            <div className='p-4'>
              ...
              <div className='px-2 grid grid-cols-6 gap-2 gap-y-4'>
                ...
                <div className="grid col-span-3 gap-2">
                  ...
                  {applicants.length > 0 && (
                    <Select
                      value={data.applicant_id ? data.applicant_id.toString() : ''}
                      onValueChange={(value) => setData('applicant_id', Number(value))}
                    >
                        ...
                        <SelectGroup>
                          ...
                          {applicants.map((applicant) => (
                            <SelectItem key={applicant.id} value={applicant.id.toString()}>
                              {applicant.last_name}, {applicant.first_name} {applicant.middle_name || ''} {applicant.suffix || ''}
                            </SelectItem>
                          ))}
                        </SelectGroup>
                      </SelectContent>
