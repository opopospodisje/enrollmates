...
const StudentIndex = ({ students,applicants }: StudentIndexProps) => {
  ...
  const handleDeleteSelected = () => {
      ...
      router.post(route("students.bulkDelete"), {
        ids: selectedIds,
      });
  ...
  function handleFilterChange(newFilter: string) {
    setFilter(newFilter);
    router.get(route('students.index', { filter: newFilter }), {}, { preserveState: true });
  }
  ...
  return (
    <div className="container">
      ...
      <div className="flex items-center justify-between my-4">
        ...
        <CreateStudentDialog applicants={applicants} />
      </div>
