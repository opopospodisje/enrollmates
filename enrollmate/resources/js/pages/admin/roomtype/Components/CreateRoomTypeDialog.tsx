...
import { CornerDownRight, List, PencilLine, Plus, SquarePlus } from 'lucide-react';
import {
  Dialog,
  DialogTrigger,
  DialogContent,
...
const CreateRoomTypeDialog = () => {
  const [open, setOpen] = useState(false);

  const { data, setData, post, processing, errors } = useForm<RoomTypeFormData>({
    name: '',
  });
