...
import CreateClassGroupSubjectDialog from './Components/CreateClassGroupSubjectDialog';
...
const ClassGroupSubjectIndex = ({classGroupSubjects, classGroups, subjects,teachers }: ClassGroupIndexProps) => {
  ...
  const handleDelete = (id: number) => {
    destroy(route('admin.classgroupsubjects.destroy', id));
  ...
  const handleDeleteSelected = () => {
      ...
      router.post(route("admin.classgroupsubjects.bulkDelete"), {
        ids: selectedIds,
      });
  ...
  return (
    <>      
      <div className="flex items-center justify-between px-4 my-4">
          ...
          {
          <CreateClassGroupSubjectDialog classGroups={classGroups} subjects={subjects} teachers={teachers}/>
          }
      </div>
