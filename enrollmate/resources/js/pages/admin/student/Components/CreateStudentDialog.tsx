...
import { CalendarCheck, CalendarDays, CornerDownRight, FileDigit, FilePlus, List, Mail, MapPin, PencilLine, Phone, Plus, SquarePlus, UserStar, VenusAndMars } from 'lucide-react';
import {
  Dialog,
  DialogTrigger,
  DialogContent,
