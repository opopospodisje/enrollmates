...
import { CalendarCheck, CalendarDays, FileDigit, FilePlus, List, Mail, MapPin, Pencil, PencilLine, Phone, SquarePen, UserStar, VenusAndMars } from 'lucide-react';
...
const EditStudentDialog = ({ student,applicants , buttonStyle}: Props) => {
  ...
  const getDefaultStudentFormData = (): Student => ({
    ...
    has_special_needs: Boolean(student.has_special_needs) || false,
    special_needs_type: student.special_needs_type || '',
    is_4ps: Boolean(student.is_4ps) || false,
  });
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='w-full grid divide-x'>
            <div className='p-4'>
              ...
              <div className='px-4 grid grid-cols-6 gap-2 gap-y-4 mb-4'>
                {/*Applicant*/}
              ...
              <div className='px-4 grid grid-cols-2 gap-2 gap-y-4 mb-4 divide divide-x'>
                <div className='space-y-4'>
                  <div className="flex items-start gap-3">
                    <Checkbox
                      id="is_4ps"
                      checked={data.is_4ps}
                      onCheckedChange={(v) => setData('is_4ps', !!v)}
                    />
                    <div className="grid gap-2">
                      <Label htmlFor="is_4ps">Is this learner a 4Ps beneficiary?</Label>
                      <p className="text-muted-foreground text-sm">
                        Mark this if the learner is a 4Ps beneficiary.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <Checkbox
                      ...
                      onCheckedChange={(v) => setData('has_special_needs', !!v)}
                    />
                    <div className="grid gap-2">
                      <Label htmlFor="special-needs">Does this learner have educational needs?</Label>
                      <p className="text-muted-foreground text-sm">
                        Click Checkbox if yes and select the classification/type below
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="grid col-span-1 gap-2">
                      <div className='flex items-center text-neutral-600 gap-2'>
                        ...
                        <Label className='font-semibold'>
                          Classification / Type of Learner Special Educational Needs (LSEN)
                        </Label>
                      </div>

                      <div className='px-4'>
                        <Select
                          value={data.special_needs_type}
                          onValueChange={(value) => setData('special_needs_type', value)}
                        >
                          <SelectTrigger className='border border-dashed border-neutral-400'>
                          ...
                          <SelectContent>
                            <SelectGroup>
                              ...
                              <SelectItem value="gifted">Gifted / Talented</SelectItem>
