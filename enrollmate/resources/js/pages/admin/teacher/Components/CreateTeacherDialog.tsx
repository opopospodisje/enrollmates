...
import { CalendarCheck, CalendarDays, CornerDownRight, List, Mail, MapPin, PencilLine, Plus, SquarePlus, VenusAndMars } from 'lucide-react';
import {
  Dialog,
  DialogTrigger,
  DialogContent,
...
const CreateTeacherDialog = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post(route('admin.teachers.store'), {
      onSuccess: () => {
        ...
        setData(getDefaultTeacherFormData());
        setOpen(false);
      },
    });
  };
  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => {
      setOpen(isOpen);
      if (isOpen) setData(getDefaultTeacherFormData());
    }}>
          ...
          <div className='w-full grid divide-x'>
            <div className='p-4'>
              <div className='flex items-center gap-2 mb-2'>
                ...
                <div className='text-sm font-bold'>Teacher Details:</div>
              </div>
